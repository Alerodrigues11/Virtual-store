...
?>
    ...
    <div class="container-fluid e-list-products">
        <h1>LISTA DE PRODUTOS</h1>
        <div class="e-list-products__content">
            <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php foreach($produtos as $produto): ?>
                            <tr class="table-tr">
                                <td class="table-td table-td-text" scope="row"><img class="e-list-products__img" src="<?= $BASE_URL?>/upload/<?= $produto["imagem"]?>" alt="Imagem do produto"></td>
                                <td class="table-td table-td-text"scope="row"><?= $produto["nome"]?></td>
                                <td class="table-td table-td-text"scope="row"><?= $produto["preco"]?></td>
                                <td class="table-td e-list-products__btn">
